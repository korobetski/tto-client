...
compilation. What is left is PvP (Phase 5, now server-mediated), four screens (Phase 4) — of
which two are the PvP pair Phase 5 unblocks and two will not be ported — and the remainder of
the test pass (Phase 7). Phase 6 is finished.
