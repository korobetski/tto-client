...
object StringKeys {
    ...
    /** On the card being consigned: the way to consign a different one. */
    const val AUCTION_CHANGE_CARD: String = "APP_AUCTION_CHANGE_CARD"
    ...
    val all: List<String> = listOf(
        ...
        AUCTION_SELL_CARD, AUCTION_CHANGE_CARD, AUCTION_SELL_EMPTY,
        AUCTION_FLOOR_HINT, AUCTION_RESERVE_HINT,
